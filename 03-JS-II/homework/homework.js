...
function esDiezOCinco(numero) {
  ...
  // Tu código  return (numer0 == 10 || numero = = 
...
function esEntero(numero) {
  ...
  // Tu código:
  return (numero == Math.trunc(numero)) ? true : false;
}
...
function fizzBuzz(numero) {
  ...
  let resp = false;
  resp = numero % 3 == 0 ? "fizz" : '';
  resp += numero % 5 == 0 ? "buzz" : '';
  return resp || numero;
}
...
function esPrimo(numero) {
  ...
  return numero % numero == 0 ? true : false;
}
...
function tablaDelSeis() {
  ...
  //Escribe tu código aquí   
  let tabla = [];
  for (let m = 0; m <= 10; m++) tabla.push(m * 6);
  return tabla;
